...
class WebsiteSaleSets(WebsiteSale):
    ...
    def get_sets(self, count=False, page=0, search='', ppg=False, **post):
        ...
        return request.render("sale_product_set_website_sale.product_set", dict(
                                product_sets=values,
                                pager=pager,
    ...
    def prodset_modal(self, product_sets=None, **post):
        ...
        return request.env['ir.ui.view'].render_template("sale_product_set_website_sale.prodset_modal", {
